...
TOOLSETS = {
    ...
    "trading": {
        "description": "Paper trading for crypto - simulate trades without real funds. Supports Solana, Ethereum, Base, Arbitrum with DEX price oracles (Jupiter, Raydium, Uniswap).",
        "tools": [
            "paper_get_balance",
            "paper_get_portfolio",
            "paper_get_stats",
