...
TOOLSETS = {
    ...
    "dex": {
        "description": "DEX swap and trading tools (Solana + SUI + Base)",
        "tools": [
            "dex_swap_quote",
            "dex_token_list",
            "dex_execute_swap",
    ...
    "onchain": {
        "description": "On-chain radar tools (Solana/Helius/SUI)",
        "tools": [
            "helius_tx_details",
            "helius_signatures",
    ...
    "trading": {
        "description": "NOFX trading integration tools for portfolio, positions, strategies, and exchange management.",
        "tools": [
            "nofx_portfolio",
            "nofx_positions",
            "nofx_strategies",
